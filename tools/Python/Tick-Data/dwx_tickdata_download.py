...
class DWX_Tick_Data():
    ...
    def __init__(self, dwx_ftp_user='EllisTaylor',
                     dwx_ftp_pass='qBv57vQ7JYx1K8',
    ...
    def _download_asset_(self, _asset='EURUSD', _date='2017-10-01', _hour='22',
                   _ftp_loc_format='{}/{}_ASK_{}_{}.log.gz',
                   _verbose=False):
...
td = DWX_Tick_Data(dwx_ftp_user='EllisTaylor',
                  dwx_ftp_pass='qBv57vQ7JYx1K8',
                  dwx_ftp_hostname='tickdata.darwinex.com',
                  dwx_ftp_port=21)

td._download_hour_(_asset='EURUSD', _date='2018-10-01', _hour='00')


td._asset_db['EURUSD-2018-10-01-15']
